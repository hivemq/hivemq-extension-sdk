...
public interface WillPublishPacket extends PublishPacket {
     ...
     * <p>
     * When the Will Publish is sent to subscribers (after the client disconnected ungracefully and the Will delay has
     * passed) the created PUBLISH packet will carry the timestamp that represents the moment when the delivery
     * started.
     * <p>
