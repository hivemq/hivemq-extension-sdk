 ...
 * thread-safe.
 * <p>
 * When the method {@link #onOutboundConnack(ConnackOutboundInput, ConnackOutboundOutput)} throws an exception or a call
 * to {@link ConnackOutboundOutput#async(Duration)} times out with {@link TimeoutFallback#FAILURE}, then the connection
...
public interface ConnackOutboundInterceptor extends Interceptor {
    ...
    /**
     * When a {@link ConnackOutboundInterceptor} is set through any extension, this method gets called for every
     * outbound CONNACK packet from any MQTT client.
     *
